      ...
      <div className="hero-left">
        ...
        <div className="hero-intro">
          ...
          <div className="hero-social">
            <a href="https://linkedin.com/" className="social-btn" title="LinkedIn" aria-label="LinkedIn">
            ...
            <a href="mailto:evelyngao@uchicago.edu" className="social-btn" title="Email" aria-label="Email">
